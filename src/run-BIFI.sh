...
python src/c002__train_breaker.py --round_name round2-BIFI-part1 --gpu_id 0 --max_epoch 3 --continue_from 'data/round1-BIFI-part1/model-breaker/checkpoint.pt'
python src/c004__run_breaker.py   --round_name round2-BIFI-part1 --gpu_ids '0,1,2,3,4'

python src/c007__generate_paired_data_from_breaker.py --round_name round2-BIFI-part1 --out_round_name round2-BIFI-part2
python src/c001__train_fixer.py --round_name round2-BIFI-part2 --gpu_id 0 --max_epoch 2 --continue_from 'data/round1-BIFI-part2/model-fixer/checkpoint.pt'
python src/c003__run_fixer.py   --round_name round2-BIFI-part2 --gpu_ids '0,1,2,3,4'
